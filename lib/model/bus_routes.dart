...
class BusRoute {
  ...
  double distanceBetween(LatLng point1, LatLng point2) {
    ...
    int index1 = path.indexWhere(
      (p) => p.latitude == point1.latitude && p.longitude == point1.longitude,
    );
    int index2 = path.indexWhere(
      (p) => p.latitude == point2.latitude && p.longitude == point2.longitude,
    );
